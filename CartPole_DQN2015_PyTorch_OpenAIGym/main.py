...
from DQN2015MLPBrain import DQN2015MLPBrain
...
def main():
    ...
    ・エージェントの行動方策の学習ロジックは、DQN (2015年バージョン)
    """
    print("Start main()")
    ...
    plt.savefig( 
        "{}_DQN2015_Reward_episode{}_lr{}.png".format( RL_ENV, NUM_EPISODE, BRAIN_LEARNING_RATE ), 
    ...
    plt.tight_layout()
    plt.savefig( 
        "{}_DQN2015_Loss_episode{}_lr{}.png".format( academy._env.spec.id, NUM_EPISODE, BRAIN_LEARNING_RATE ), 
        dpi = 300, bbox_inches = "tight"
    )
    plt.show()
