...
class MazePolicyIterationAgent( Agent ):
    """
    迷路探索用エージェント。
    ...
    def print( self, str ):
        print( "----------------------------------" )
        print( "MazePolicyIterationAgent" )
        print( self )
        print( str )
        print( "_brain : \n", self._brain )
        print( "_observations : \n", self._observations )
