...
def main():
    ...
    plt.savefig( "MazaSimple_EveryVisitMC_Reward_episode{}.png".format(NUM_EPISODE), dpi = 300, bbox_inches = "tight" )
    plt.show()
    ...
    plt.savefig( "MazaSimple_EveryVisitMC_VFunction_episode{}.png".format(NUM_EPISODE), dpi = 300, bbox_inches = "tight" )
    plt.show()
    ...
    def draw_q_function( q_func ):
        ...
        plt.savefig( "MazaSimple_EveryVisitMC_Qfunction_episode{}.png".format(NUM_EPISODE), dpi = 200, bbox_inches = "tight" )
        plt.show()
